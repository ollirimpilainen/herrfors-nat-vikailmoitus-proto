...
Worth deciding deliberately rather than by default: if the policy is consent-driven,
the map stays blank until a reporter accepts cookies. For someone reporting a downed
power line at 3am that is a poor first experience, and it argues for treating the map
as strictly necessary — or for proxying tiles through the site's own domain, which
